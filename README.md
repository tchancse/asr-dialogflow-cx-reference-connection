# Google STT/Dialogflow CX reference connection code
...
please take note of the ngrok **Enpoint URL** as it is needed when setting up the corresponding [sample server application](https://github.com/nexmo-se/asr-dialogflow-cx-sample-voice-application) using Vonage Voice API,
